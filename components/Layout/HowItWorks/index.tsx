...
export default function HowItWorks({ onboardDialog }: { onboardDialog: DisclosureState }) {
  ...
  return (
    <div className="mb-[-5rem] flex flex-col items-center justify-between gap-16 bg-lp-GREY-1 p-10 text-lp-gray-5 dark:bg-lp-gray-5 dark:text-lp-white sm:p-20 sm:!py-[4.5rem] xl:p-24">
      ...
      {/* <div className="flex flex-col gap-4 lg:w-full lg:flex-row">
        {features.map((feature) => (
          <article
            key={feature.name}
            className="flex max-w-xl flex-1 flex-col flex-nowrap gap-4 rounded-[0.375rem] bg-lp-gray-2 p-6 text-xl dark:bg-lp-gray-4 dark:bg-opacity-30 sm:flex-row sm:items-center sm:gap-10 lg:w-full lg:max-w-full"
          >
      ...
      {/* <div className="grid grid-cols-1 gap-[0.625rem] lg:w-full lg:grid-cols-2">
        {pros.map((pro) => (
          <article
            key={pro.name}
            className="col-span-1 flex max-w-xl flex-col gap-[0.625rem] rounded-[0.375rem] bg-lp-white p-8 text-center text-xl dark:bg-lp-gray-4 lg:max-w-full"
          >
      ...
      <div className="mt-5 flex w-[calc(100vw-16px)] select-none flex-col gap-20 lg:mb-[-4.5rem]">
        ...
        {/* <div className="flex w-full flex-col items-center bg-lp-gray-3 dark:bg-lp-gray-3">
          <div className="relative z-20 mt-[-2.25rem] mb-[-3.75rem] flex flex-col gap-[0.625rem] rounded-[0.375rem] bg-lp-white px-6 py-10 shadow-[0px_4px_12px_rgba(0,0,0,0.15)] dark:bg-lp-gray-4">
